        ...
        <section class="services" role="region" aria-label="Barbershop services">
            ...
            <div class="services-list-wrapper">
                <ul class="services-list">
                    <li class="services-list-item">Haircut</li>
                    <li class="services-list-item">Shaving</li>
                    <li class="services-list-item">Beard Trim</li>
                    <li class="services-list-item">Mustache Trim</li>
                </ul>
