        ...
        <section class="counter" role="region" aria-label="Barbershop statistics">
            <ul class="counter-list">
                <li class="counter-item">
                    <img src="assets/images/icons/counter/icon_scissors.svg" alt="Scissors icon" class="counter-item-icon">
                    <h3 class="counter-item-title">2500</h3>
                    <p class="counter-item-text">SHAVES</p>
                </li>
                <li class="counter-item">
                    <img src="assets/images/icons/counter/icon_haircut.svg" alt="Haircut icon" class="counter-item-icon">
                    <h3 class="counter-item-title">4500</h3>
                    <p class="counter-item-text">HAIRCUTS</p>
                </li>
                <li class="counter-item">
                    <img src="assets/images/icons/counter/icon_beard.svg" alt="Beard icon" class="counter-item-icon">
                    <h3 class="counter-item-title">1500</h3>
                    <p class="counter-item-text">BEARD TRIMS</p>
            </ul>
        </section>
